...
const TOKEN_DETAILS: Record<string, TokenDetails> = {};
...
async function fetchTokenDetails(
  ...
  try {
    ...
    TOKEN_DETAILS[tokenAddressLower] = details;
    ...
    const fallbackDetails = { symbol: "UNKNOWN", decimals: 18, isFallback: true };
    TOKEN_DETAILS[tokenAddressLower] = fallbackDetails;
