...
export const multiprovider = new ethers.JsonRpcProvider(process.env.RPC_COMUM!,10);
export const alchemysupport= new ethers.JsonRpcProvider(process.env.ALCHEMY_RPC!,10);
export const blastprovider = new ethers.WebSocketProvider(process.env.BLASTPROVIDER!,10);
export const quicknodeprovider = new ethers.WebSocketProvider(process.env.QUICKNODEPROVIDER!,10);
export const alchemyprovider = new ethers.WebSocketProvider(process.env.ALCHEMY_WSS!,10);
export const infuraprovider = new ethers.WebSocketProvider(process.env.INFURA_WSS!,10);
export const infurasupport = new ethers.JsonRpcProvider(process.env.INFURA_RPC!,10);
export const quicknodesupport = new ethers.JsonRpcProvider(process.env.QUICKNODESUPPORT!,10);
