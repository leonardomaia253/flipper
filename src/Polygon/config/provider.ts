...
export const multiprovider = new ethers.JsonRpcProvider(process.env.RPC_COMUM!,137);
export const alchemysupport= new ethers.JsonRpcProvider(process.env.ALCHEMY_RPC!,137);
export const blastprovider = new ethers.WebSocketProvider(process.env.BLASTPROVIDER!,137);
export const quicknodeprovider = new ethers.WebSocketProvider(process.env.QUICKNODEPROVIDER!,137);
export const alchemyprovider = new ethers.WebSocketProvider(process.env.ALCHEMY_WSS!,137);
export const infuraprovider = new ethers.WebSocketProvider(process.env.INFURA_WSS!,137);
export const infurasupport = new ethers.JsonRpcProvider(process.env.INFURA_RPC!,137);
export const quicknodesupport = new ethers.JsonRpcProvider(process.env.QUICKNODESUPPORT!,137);
