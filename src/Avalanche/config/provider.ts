...
export const multiprovider = new ethers.JsonRpcProvider(process.env.RPC_COMUM!,43114);
export const alchemysupport= new ethers.JsonRpcProvider(process.env.ALCHEMY_RPC!,43114);
export const blastprovider = new ethers.WebSocketProvider(process.env.BLASTPROVIDER!,43114);
export const quicknodeprovider = new ethers.WebSocketProvider(process.env.QUICKNODEPROVIDER!,43114);
export const alchemyprovider = new ethers.WebSocketProvider(process.env.ALCHEMY_WSS!,43114);
export const infuraprovider = new ethers.WebSocketProvider(process.env.INFURA_WSS!,43114);
export const infurasupport = new ethers.JsonRpcProvider(process.env.INFURA_RPC!,43114);
export const quicknodesupport = new ethers.JsonRpcProvider(process.env.QUICKNODESUPPORT!,43114);
