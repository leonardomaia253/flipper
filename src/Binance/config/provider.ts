...
export const multiprovider = new ethers.JsonRpcProvider(process.env.RPC_COMUM!,56);
export const alchemysupport= new ethers.JsonRpcProvider(process.env.ALCHEMY_RPC!,56);
export const blastprovider = new ethers.WebSocketProvider(process.env.BLASTPROVIDER!,56);
export const quicknodeprovider = new ethers.WebSocketProvider(process.env.QUICKNODEPROVIDER!,56);
export const alchemyprovider = new ethers.WebSocketProvider(process.env.ALCHEMY_WSS!,56);
export const infuraprovider = new ethers.WebSocketProvider(process.env.INFURA_WSS!,56);
export const infurasupport = new ethers.JsonRpcProvider(process.env.INFURA_RPC!,56);
export const quicknodesupport = new ethers.JsonRpcProvider(process.env.QUICKNODESUPPORT!,56);
